          ...
          child: Column(
            ...
            children: [
              ...
              ExerciseCardWidget(
                ...
                onTap: () {
                  context.push('/exercices/details/${widget.post.exercice.id}', extra: widget.post.exercice);
                },
              ),
              const SizedBox(height: 18),
              Row(
                ...
                children: [
                  _buildInfoCard(
                    formatDurationTraining(widget.post.startAt, widget.post.endAt),
                    'Durée',
                  ),
              ...
              ActionButtonsPostWidget(
                ...
                onCommentTap: () {
                  context.push('/home/details/${widget.post.id}/comments', extra: widget.post);
                },
              ),
              const SizedBox(height: 18),
...
void _showCreateChallengeUserDialog(BuildContext context) {
  showDialog(
    ...
    builder: (BuildContext context) {
      ...
      String description = '';
      DateTime endDate = DateTime.now(); // Implement date picker or use a predefined date
            ...
            onPressed: () {
              if (_formKey.currentState!.validate()) {
                ...
                context.read<ChallengesUsersBloc>().add(CreateChallengeEvent(
                  ...
                  endDate: endDate,
                  trainingId: widget.post.exercice.id, // Modify based on your data
                  authorId: userId!,
                  type: type,
                  invites: invites,
